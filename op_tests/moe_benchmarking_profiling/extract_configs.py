...
Usage:
    python 00_extract_configs.py trace.json -o config.csv

Key Features:
    - Extracts all MOE-related configuration from trace events
    - Handles multiple configuration detection
    - Generates benchmark-ready CSV format
    - Configurable token count sweep
"""
